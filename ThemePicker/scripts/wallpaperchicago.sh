echo "Changing wallpaper to a Chicago 95 themed one"
...
# Variables
WALLPAPER="$HOME/.config/ThemePicker/chicago-theme/rofi-theme/chicago.jpg"
...
set_sddm_wallpaper() {
  ...
  if yad --info --text="Set current wallpaper as SDDM background?\n\nNOTE: This only applies to SEQUOIA SDDM Theme" \
   ...
   #hyprlock
    HYPRLOCK_SOURCE="$HOME/.config/ThemePicker/chicago-theme/hyprlock.conf"
